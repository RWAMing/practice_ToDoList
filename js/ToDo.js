...
function typeBox_TD_txt() { // 유저가 input에 입력한 ToDo
    return typeBox_TD.value;
}
function TD_txt_blank() { // 빈칸인지 체크
    return typeBox_TD_txt().trim() == ''; // *** trim을 이용하기
}
...
function show_btn_change_order() {
    ...
    lists_style.forEach(function (list_style) {
        ...
        list_style.classList.add('ani_reset');
        list_style.classList.remove('ani_reset');
        list_style.classList.remove('edit_style_hide');
        list_style.classList.add('edit_style_show');
        console.log(list_style.style.animationPlayState);
        console.log(list_style.style.animationDirection);
    });
}
// list-style 모양 원래대로
function hide_btn_change_order() {
    ...
    lists_style.forEach(function (list_style) {
        ...
        list_style.classList.add('ani_reset');
        list_style.classList.remove('ani_reset');
        list_style.classList.remove('edit_style_show');
        list_style.classList.add('edit_style_hide');
        console.log(list_style.style.animationPlayState);
        console.log(list_style.style.animationDirection);
    });
}
